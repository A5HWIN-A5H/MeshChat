...
import { UserPlus, Mail, User, KeyRound, ArrowRight } from 'lucide-react';
    ...
    <div className="flex min-h-screen items-center justify-center bg-[#313338] px-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-[#949ba4] mt-1">Generate your decentralized E2EE identity</p>
        </div>
        ...
        <form onSubmit={handleRegister} className="space-y-4">
          <div>
            <label className="block text-xs font-bold uppercase tracking-wider text-[#949ba4] mb-2">Username</label>
            <div className="relative">
              <User className="absolute left-3.5 top-3.5 w-4 h-4 text-[#949ba4]" />
              <input
                type="text"
                value={username}
          ...
          >
            <span>{isLoading ? 'Generating Keypair...' : 'Register & Connect'}</span>
